...
let server = path [ solutionRoot; "WebApi" ]
let client =  path [ solutionRoot; "WebLit" ]
let serverTests = path [ solutionRoot; "WebApi.Tests" ]
let clientTests = path [ solutionRoot; "WebLit.Tests" ]
